...
# Use os.getcwd() to get the current working directory in Databricks or notebooks
current_dir = os.getcwd()

# Assuming the 'common.py' file is in a directory called 'src' one level up
